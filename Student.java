...
public class Student extends RegularMember {
	...
	public Student(String memberName,int ID) {
...
public boolean addOA(OnlineArticle oa) {
		if(accessableOnlineArticle.size() < 2) {
  ...
  public void displayInfo() {
	  System.out.println(ConsoleColors.GREEN_UNDERLINED+"Account type:Student");
	  super.displayInfo();
